				...
				items={[
					{
						title: "Work 1",
						images: [
							{ src: "https://picsum.photos/200?random=1", alt: "Screenshot 1" },
							{ src: "https://picsum.photos/200?random=2", alt: "Screenshot 2" },
							{ src: "https://picsum.photos/200?random=3", alt: "Screenshot 3" }
						],
						description: `
